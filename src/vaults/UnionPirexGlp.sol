...
contract UnionPirexGlp is Owned, ERC4626 {
    using SafeTransferLib for ERC20;
    using FixedPointMathLib for uint256;

    UnionPirexGlpStaking public strategy;
    ...
    function setStrategy(address _strategy) external onlyOwner {
        ...
        strategy = UnionPirexGlpStaking(_strategy);
    ...
    /**
        @notice Get the pxGLP custodied by the UnionPirex contracts
    ...
    function harvest() public {
        ...
        if (rewards != 0) {
            ...
            // Claimed rewards should be in pxGLP
